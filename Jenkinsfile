        ...
        stage('Prepare') {
            ...
            steps {
                ...
                container('r') {
                    ...
                    sh "install2.r -r https://cloud.r-project.org -r https://cran.obiba.org --error git2r devtools pkgdown mockery MolgenisAuth fields metafor DSI gridExtra dsBaseClient ellipsis vctrs covr"
